...
$folder="../../";
$titulo="Registro de Nuevo Archivo Común";
    	...
    	<div class="prefix_3 grid_4 alpha">
			<fieldset>
				...
				<table class="tablareg">
					<tr>
						<td colspan="2"><?php campos("Nombre","nombre","text","",1,array("required"=>"required","size"=>"50"));?></td>
					</tr>
                    <tr>
						<td colspan="2"><?php campos("Tipo","tipo","text","",0,array("required"=>"required","size"=>"50"));?></td>
					</tr>
                    <tr>
